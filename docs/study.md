...
1.[Markdown语法](https://markdown.com.cn/basic-syntax/){:target="_blank"}  
...
3.[CS-Plan](https://cs-plan.com/){:target="_blank"}  
4.[CS-DIY](https://csdiy.wiki/){:target="_blank"}  
5.[Awesome-CS](https://github.com/SJTU-CSE/awesome-cs){:target="_blank"}  
6.[Kernel-Exploring](https://richardweiyang-2.gitbook.io/kernel-exploring){:target="_blank"}    
7.[The-Linux-Man-Pages-Project](https://kernel.org/doc/man-pages/){:target="_blank"}    
8.[Linux-101](https://101.lug.ustc.edu.cn/){:target="_blank"}  
9.[Deep-Dive-Into-Linux-Page-Cache](https://biriukov.dev/docs/page-cache/0-linux-page-cache-for-sre/){:target="_blank"}   
10.[Is Parallel Programming Hard, And, If So, What Can You Do About It?](http://www2.rdrop.com/~paulmck/){:target="_blank"}   
11.[Linux-From-Scratch-CN](https://lfs.xry111.site/zh_CN/){:target="_blank"}  
12.[Linux-From-Scratch-LoongArch-CN](https://lfs.xry111.site/zh_CN/loongarch-systemd/index.html){:target="_blank"}    
13.[Beyond-Linux-From-Scratch](https://www.linuxfromscratch.org/blfs/view/stable-systemd/){:target="_blank"}   
14.[计算机系统基础 课程实验-2025](https://nju-projectn.github.io/ics-pa-gitbook/ics2025/){:target="_blank"}   
...
2.[机器学习系统：设计和实现](https://openmlsys.github.io/index.html){:target="_blank"}  
...
4.[青蛙小白-云原生(Cloud Native)](https://blog.frognew.com/library/cloudnative.html){:target="_blank"}  
